...
function ztr20(v,a,b,i2){
    let r=v/((parseFloat(a.value)*parseFloat(b.value)-i2.toFixed(2)))*100000;
    r=r.toFixed(2);
    g.value=r;
    let v4=v/((parseFloat(a.value)*parseFloat(b.value)-i2.toFixed(3)))*100000;
    v4=v4.toFixed(2);
    gc.value=v4;
    var v5=(v/(parseFloat(a.value)*parseFloat(b.value)-Math.floor(i2*100)/100)*100000).toFixed(2);
    zbs.value=v5;
}
